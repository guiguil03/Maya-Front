...
export default function TestimonialsSection() {
  return (
    <section id="testimonials" className="relative py-16 sm:py-24 lg:py-32 px-4 sm:px-6 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
        ...
        <div className="relative px-2 sm:px-4 md:px-8">
          ...
          >
            ...
            <div className="px-2 sm:px-3">
              <div className="p-4 sm:p-6 lg:p-8 bg-white rounded-2xl sm:rounded-3xl border border-gray-200 hover:shadow-xl transition-all h-full">
                ...
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-gradient-to-br from-[#8B2635] to-[#C13048] rounded-full flex items-center justify-center text-white text-base sm:text-lg lg:text-xl font-bold flex-shrink-0">
                    M
                  </div>
                  <div>
                    <div className="font-bold text-gray-900 text-sm sm:text-base">Marie Lefèvre</div>
                    <div className="text-xs sm:text-sm text-gray-500">Étudiante</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="px-2 sm:px-3">
              <div className="p-4 sm:p-6 lg:p-8 bg-white rounded-2xl sm:rounded-3xl border border-gray-200 hover:shadow-xl transition-all h-full">
                ...
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    <div className="font-bold text-gray-900 text-sm sm:text-base">Emily Anne Roberts</div>
                    <div className="text-xs sm:text-sm text-gray-500">Commerçante</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="px-2 sm:px-3">
              <div className="p-4 sm:p-6 lg:p-8 bg-white rounded-2xl sm:rounded-3xl border border-gray-200 hover:shadow-xl transition-all h-full">
                ...
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    <div className="font-bold text-gray-900 text-sm sm:text-base">Jean Johnson</div>
                    <div className="text-xs sm:text-sm text-gray-500">Entrepreneur</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="px-2 sm:px-3">
              <div className="p-4 sm:p-6 lg:p-8 bg-white rounded-2xl sm:rounded-3xl border border-gray-200 hover:shadow-xl transition-all h-full">
                ...
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    <div className="font-bold text-gray-900 text-sm sm:text-base">Alexander John Parker</div>
                    <div className="text-xs sm:text-sm text-gray-500">Manager Commercial</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="px-2 sm:px-3">
              <div className="p-4 sm:p-6 lg:p-8 bg-white rounded-2xl sm:rounded-3xl border border-gray-200 hover:shadow-xl transition-all h-full">
                ...
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    <div className="font-bold text-gray-900 text-sm sm:text-base">Sophie Martin</div>
                    <div className="text-xs sm:text-sm text-gray-500">Chef d'Entreprise</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="px-2 sm:px-3">
              <div className="p-4 sm:p-6 lg:p-8 bg-white rounded-2xl sm:rounded-3xl border border-gray-200 hover:shadow-xl transition-all h-full">
                ...
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    <div className="font-bold text-gray-900 text-sm sm:text-base">Michael Edward Brooks</div>
                    <div className="text-xs sm:text-sm text-gray-500">Consultant Business</div>
                  </div>
                </div>
              </div>
            </div>
